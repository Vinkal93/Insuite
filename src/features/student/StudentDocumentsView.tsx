...
import { Award, CreditCard, Printer, Eye, AlertCircle, RefreshCw, QrCode } from "lucide-react";
...
export const StudentDocumentsView: React.FC = () => {
  ...
  const loadDocuments = async () => {
    ...
    try {
      ...
      console.error("loadStudentDocuments error:", err);
    ...
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-black tracking-tight text-foreground sm:text-3xl">
          My Certificates & ID Cards
        </h1>
        <p className="text-xs text-muted-foreground mt-0.5">
          Official school credentials, bonafide certificates, and student ID badges.
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="rounded-3xl border border-border bg-card p-12 text-center shadow-soft">
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Official certificates and ID cards generated by the school will appear here.
          </p>
        </div>
      ) : (
